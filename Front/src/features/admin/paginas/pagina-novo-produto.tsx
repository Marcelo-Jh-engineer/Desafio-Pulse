...
import { useCadastrarProduto, useCategoriasAdmin } from '@/features/admin/hooks/use-admin';
...
export function PaginaNovoProduto() {
  ...
  // Conflito de SKU volta do servidor no proprio campo.
  useEffect(() => {
          ...
          >
            ...
            >
              ...
              >
                ...
                {/* So categorias ativas: cadastrar em categoria desativada
                    criaria produto invisivel no catalogo publico. */}
                {categorias.data
